        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="section-title text-center ">
                    <h2 class="title " style="font-weight: 700;">Why CloudSpinx <span style="color: #DA4719;">Products?</span></h2>
                </div>
            </div><!--end col-->
        </div><!--end row-->
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                <div class="card service-wrapper rounded border-0 shadow p-4">
                    <div class="icon text-center text-custom h1 shadow rounded bg-white-2">
                    ...
                    <div class="content mt-4">
                        <h5 class="title">Expert-Written Content</h5>
                        <p class="text-muted mt-3 mb-0">Covering a vast array of technologies and certifications.</p>
