...
@section('content')
    @include('front.partials._slider', ['sliderPageTitle' => 'Post Details'])
    <div class="blog-single gray-bg mt-5 mb-5">
        <div class="container">
                ...
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        ...
                        <div class="article-title">
                            ...
                            <div class="media">
                                <div class="avatar">
                                    <img src="https://bootdey.com/img/Content/avatar/avatar1.png" width="100%" title="" alt="">
                                </div>
