...
@section('content')
    @include('front.partials._slider', ['sliderPageTitle' => 'Contact Us'])
    <section>
                ...
                <div class="row no-gutters">
                    <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-5 order-lg-2">
                        ...
                        <ul class="contact-info__list list-style--none position-relative z-index-101">
                            <li class="mb-4 pl-4">
                                <span class="position-absolute"><i class="fas  fa-envelope"></i></span> <span class="ms-4">support@site.com</span>
                            </li>
                            <li class="mb-4 pl-4">
                                <span class="position-absolute"><i class="fas  fa-phone"></i></span> <span class="ms-4">(021)-241454-545</span>
                            </li>
                            <li class="mb-4 pl-4">
                                <span class="position-absolute"><i class="fas  fa-map-marker"></i></span> <span class="ms-4">2694 Queen City Rainbow Drive
                                  <br> Florida 99161
                                  </span>
                    ...
                    <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1">
                        <form action="#" class="contact-form form-validate" novalidate="novalidate">
                            <div class="row">
                                ...
                                <div class="col-sm-12 mb-3">
                                    <button type="submit" name="submit" class="btn btn-primary p-3">Submit</button>
                                </div>
