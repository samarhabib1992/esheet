...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 bold mt-4">Add Blog Category</h1>
    </div>
    <!-- Content Row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 mt-4">
                                        <a href="{{ route('admin.blogcategories.listing') }}" class="btn btn-outline-dark w-100">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).on('click', '#submitBtn', function(e) {
        ...
        submitAjaxForm(formId, "{{ route('admin.blogcategories.store') }}", commonData);
    });
</script>
@if(isset($row) && !empty($row))
<script type="text/javascript">
$(document).on('click', '#updateBtn', function(e) {
        ...
        let commonData = {};
        // Call the submit function dynamically based on form ID
        submitAjaxForm(formId, "{{ route('admin.blogcategories.update', ['id' => $row->id]) }}", commonData);
