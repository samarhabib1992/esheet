...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <form class="d-none d-sm-inline-block form-inline mr-auto my-2 my-md-0 mw-100 navbar-search">
        <div class="input-group">
            <p style="position: relative; top: 8px; right: -2pc; z-index: 2;">
                <i class="fas fa-search fa-sm"></i>
            </p>
            <input type="text" class="form-control bg-light border-0 small pl-5" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" style="border-radius: 1rem;">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div class="font-weight-bold">
                        <div class="text-truncate">Hi there! I wanted to reach out and let you know...</div>
